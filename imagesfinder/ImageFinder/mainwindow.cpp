...
void MainWindow::on_findButton_clicked()
{
    ...
    std::string cmd = "/Users/duy/unix/project1/imagesfinder/ImageFinder/findFile.sh \""+ path.toStdString()+
            "\"";
    char buffer[512];
...
bool checkDir(std::string dirPath){
    int found;
    std::string bashCmd = "/Users/duy/unix/project1/imagesfinder/ImageFinder/checkDir.sh \""+dirPath+"\"";
